...
int __send_message(MESSAGE* msg_ptr, int device);
int __request_message(uint8_t msg_type, int device);
int __get_message(MESSAGE* msg, uint8_t msg_type, int device);
int wire_errorhandler(int error);
...
int __get_message(MESSAGE* msg_ptr, uint8_t msg_type, int device) {
