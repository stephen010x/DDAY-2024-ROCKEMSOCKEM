...
static void wire_slaveInit();
static void __process_message(MESSAGE* msg_ptr);
static void __process_request(MESSAGE* msg_ptr);
static void __read_message(MESSAGE* msg_ptr);
...
static void __process_request(MESSAGE* msg_ptr) {
  wire_process_request(&MSGclaim, msg_ptr->request);
